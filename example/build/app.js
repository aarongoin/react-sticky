...
},{"../index":3,"react":147}],3:[function(require,module,exports){
...
function validateLifeCycleOnReplaceState(instance) {
  ...
  ("production" !== "" ? invariant(
    ...
    compositeLifeCycleState === CompositeLifeCycle.MOUNTING));
  ("production" !== "" ? invariant(compositeLifeCycleState !== CompositeLifeCycle.RECEIVING_STATE,
    'replaceState(...): Cannot update during an existing state transition ' +
    '(such as within `render`). This could potentially cause an infinite ' +
    'loop so it is forbidden.'
  ) : invariant(compositeLifeCycleState !== CompositeLifeCycle.RECEIVING_STATE));
  ("production" !== "" ? invariant(compositeLifeCycleState !== CompositeLifeCycle.UNMOUNTING,
    ...
    for (var propName in propTypes) {
      if (propTypes.hasOwnProperty(propName)) {
        ...
        if (error instanceof Error) {
          ...
          ("production" !== "" ? warning(false, error.message + addendum) : null);
        }
      }
    }
  },
...
function getEventKey(nativeEvent) {
  ...
  ("production" !== "" ? invariant(false, "Unexpected keyboard event type: %s", nativeEvent.type) : invariant(false));
}
...
},{"./emptyFunction":105}],147:[function(require,module,exports){
